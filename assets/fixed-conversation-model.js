(function(root, factory) {
  ...
  return {STEPS,REPLIES,INVITE,RESULT_INTRO,progress,composerDraft,LABELS,PROMPTS,PRESET,SUMMARY,createFlow,presetFlow,accept,answer,confirm,claim,pause,resume,exampleDraft,resultFor};
});
