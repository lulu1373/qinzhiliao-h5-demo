...
styles += ['course.css', 'course-v2.css', 'icon-soft3d.css', 'icon-v4-drawer.css', 'archive-v3.css', 'card-motion-v2.css', 'message-toolbar.css', 'points-v2.css', 'points-v3.css', 'membership-benefits-v2.css', 'settings-icons-v2.css']
scripts += ['course-model.js', 'course-view.js', 'card-motion-v2.js', 'points-v2-model.js', 'points-v3-icons.js', 'points-v2-view.js', 'membership-benefit-icons.js', 'settings-icons-v2.js', 'fixed-conversation-model.js']
resources = ['fixed-conversation.css', 'community-screen-time.webp', 'community-school-ready.webp', 'community-family-walk.webp', 'icons/jiankuai-classroom.svg', 'icons/my-learning.svg', 'icons/growth-points.svg', 'icons/app-v4/assessment.svg', 'icons/app-v4/community.svg', 'icons/app-v4/family-archive.svg', 'icons/app-v4/membership.svg', 'icons/app-v4/feedback.svg']
