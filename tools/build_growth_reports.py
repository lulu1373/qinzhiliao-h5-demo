...
styles += ['course.css', 'course-v2.css', 'icon-soft3d.css', 'message-toolbar.css', 'points-v2.css', 'points-v3.css', 'membership-benefits-v2.css']
scripts += ['course-model.js', 'course-view.js', 'points-v2-model.js', 'points-v3-icons.js', 'points-v2-view.js', 'membership-benefit-icons.js']
