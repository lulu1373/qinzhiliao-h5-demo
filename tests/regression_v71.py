...
ARTIFACT=Path('/mnt/data/亲智聊-H5-App-Demo-V7.1-成长总结完成版.html')
OUT=Path('/mnt/data/v71-test-output')
...
async def main():
  async with async_playwright() as p:
    ...
    expect('版本标记', await page.evaluate('window.__QZL_VERSION')=='7.1', version=await page.evaluate('window.__QZL_VERSION'))
