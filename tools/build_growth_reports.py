...
scripts += ['course-model.js', 'course-view.js', 'card-motion-v2.js', 'points-v2-model.js', 'points-v3-icons.js', 'points-v2-view.js', 'membership-benefit-icons.js', 'settings-icons-v2.js']
