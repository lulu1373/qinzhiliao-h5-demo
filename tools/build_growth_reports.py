...
styles += ['course.css', 'course-v2.css', 'icon-3d-fluency.css']
...
resources += [str(path.relative_to(ROOT / 'assets')) for path in sorted((ROOT / 'assets/icons/3d-fluency').glob('*.png'))]
