...
styles += ['course.css', 'course-v2.css', 'icon-soft3d.css', 'icon-v4-drawer.css', 'message-toolbar.css', 'points-v2.css', 'points-v3.css', 'membership-benefits-v2.css', 'settings-icons-v2.css']
